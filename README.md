...
[![](https://img.shields.io/david/fsr/matthias.svg)](https://david-dm.org/fsr/matthias)


matthias is a chat bot built on the [Hubot][hubot] framework. It was
...
Matthias also stores stuff in redis, his brain. So go ahead and install that.
